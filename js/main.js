...
canvasOOP.width = "300";
canvasOOP.style.background = "#F87CBC";
...
let miCirculo = new Circle(150, 100, 50, 'black', 'Tec', 'rgb(87, 68, 234 )');
miCirculo.draw(ctx);
...
canvasMovi.style.background = "#FF369E";

let randomX = Math.random() * canvasMovi.width;
let randomY = Math.random() * canvasMovi.height;
let randomRadius = Math.floor(Math.random() * 100 + 30);

let miCirculoMovimiento = new Circle(randomX, randomY, randomRadius, 'white', 'Salma', 'rgb(0, 214, 223  )');
...
canvasMultiple.style.background = "#F90080";
...
for (let i = 0; i < 10; i++) {
    ...
    let miCirculoMultiple = new Circle(randomX, randomY, randomRadius, "black", i + 1, 'rgb(40, 198, 180 )');
